...
async def variableupdater(server):
    ...
    while True:
        ...
        node_values = {
            ...
            6021: (float(values['progressPrintTime']), ua.VariantType.Double),
            6022: (float(values['temperatureAActual']),ua.VariantType.Double),
            6023: (str(values['fileName0']), ua.VariantType.String),
            6024: (str(values['fileType0']), ua.VariantType.String),
            6025: (float(values['jobEstimatedPrintTime']), ua.VariantType.Double),
            ...
            6029: (float(values['progressPrintTimeLeft']), ua.VariantType.Double),
            6030: (float(values['jobFilamentLength']), ua.VariantType.Double),
            6031: (str(values['fileName4']), ua.VariantType.String),
            6032: (str(values['fileType4']), ua.VariantType.String),
            6034: (float(values['currentToolTemperatureActual']), ua.VariantType.Double),
            6035: (str(values['fileName5']), ua.VariantType.String),
            6036: (str(values['fileType5']), ua.VariantType.String),
            6037: (float(values['jobFilamentVolume']), ua.VariantType.Double),
            ...
            6042: (float(values['progressCompletion']), ua.VariantType.Double),
            ...
            6046: (float(values['currentBedTemperatureActual']), ua.VariantType.Double),
            6047: (str(values['fileName8']), ua.VariantType.String),
            6048: (str(values['fileType8']), ua.VariantType.String),
            6052: (float(values['temperatureATarget']), ua.VariantType.Double),
            6053: (str(values['spoolName9']), ua.VariantType.String),
            6054: (float(values['spoolCost1']), ua.VariantType.Double),
            6055: (float(values['currentBedTemperatureTarget']), ua.VariantType.Double),
            6056: (float(values['spoolProfileDensity1']), ua.VariantType.Double),
            6057: (float(values['spoolProfileDiameter1']), ua.VariantType.Double),
            6058: (float(values['currentToolTemperatureTarget']), ua.VariantType.Double),
            6059: (str(values['spoolProfileMaterial1']), ua.VariantType.String),
            6060: (float(values['spoolTempOffset1']), ua.VariantType.Double),
            6061: (float(values['temperatureAOffset']), ua.VariantType.Double),
            6062: (float(values['spoolUsed1']) , ua.VariantType.Double),
            6063: (str(values['spoolProfileVendor1']), ua.VariantType.String),
            6064: (float(values['currentBedTemperatureOffset']), ua.VariantType.Double),
            6065: (float(values['spoolWeight1']), ua.VariantType.Double),
            6066: (float(values['spoolCost2']), ua.VariantType.Double),
            6067: (float(values['currentToolTemperatureOffset']), ua.VariantType.Double),
            6068: (float(values['printerProfileAxeESpeed']), ua.VariantType.Double),
            6069: (float(values['printerProfileAxeXSpeed']), ua.VariantType.Double),
            6070: (float(values['printerProfileAxeYSpeed']), ua.VariantType.Double),
            6071: (float(values['printerProfileAxeZSpeed']), ua.VariantType.Double),
            6072: (float(values['spoolProfileDensity2']), ua.VariantType.Double),
            6073: (float(values['spoolProfileDiameter2']), ua.VariantType.Double),
            6074: (float(values['printerProfileExtruderDefaultExtrusionLength']), ua.VariantType.Double),
            6075: (str(values['spoolProfileMaterial2']), ua.VariantType.String),
            6076: (float(values['spoolTempOffset2']), ua.VariantType.Double),
            6077: (float(values['printerProfileExtruderNozzleDiameter']), ua.VariantType.Double),
            6078: (float(values['spoolUsed2']), ua.VariantType.Double),
            6079: (str(values['spoolProfileVendor2']), ua.VariantType.String),
            6080: (float(values['printerProfileExtruderOffsetX']), ua.VariantType.Double),
            6081: (float(values['spoolWeight2']), ua.VariantType.Double),
            6082: (float(values['spoolCost3']), ua.VariantType.Double),
            6083: (float(values['printerProfileExtruderOffsetY']), ua.VariantType.Double),
            6084: (float(values['printerProfileVolumeCustom_boxX_min']), ua.VariantType.Double),
            6085: (float(values['printerProfileVolumeCustom_boxX_max']), ua.VariantType.Double),
            6086: (float(values['printerProfileVolumeCustom_boxY_max']), ua.VariantType.Double),
            6087: (float(values['printerProfileVolumeCustom_boxY_min']), ua.VariantType.Double),
            6088: (float(values['printerProfileVolumeCustom_boxZ_max']), ua.VariantType.Double),
            6089: (float(values['printerProfileVolumeCustom_boxZ_min']), ua.VariantType.Double),
            6090: (float(values['printerProfileVolumeWidth']), ua.VariantType.Double),
            6091: (float(values['printerProfileVolumeDepth']), ua.VariantType.Double),
            6092: (float(values['printerProfileVolumeHeight']), ua.VariantType.Double),
            6093: (float(values['spoolProfileDensity3']), ua.VariantType.Double),
            6094: (float(values['spoolProfileDiameter3']), ua.VariantType.Double),
            6095: (str(values['selectedSpoolName']), ua.VariantType.String),
            6096: (float(values['selectedSpoolCost']), ua.VariantType.Double),
            6097: (float(values['selectedSpoolProfileDensity']), ua.VariantType.Double),
            6098: (float(values['selectedSpoolProfileDiameter']), ua.VariantType.Double),
            ...
            6101: (float(values['selectedSpoolTempOffset']), ua.VariantType.Double),
            6102: (float(values['selectedSpoolUsed']), ua.VariantType.Double),
            6103: (float(values['selectedSpoolWeight']), ua.VariantType.Double),
            6104: (str(values['spoolProfileMaterial3']), ua.VariantType.String),
            6105: (float(values['spoolTempOffset3']), ua.VariantType.Double),
            6106: (str(values['spoolName0']), ua.VariantType.String),
            6107: (float(values['spoolCost0']) , ua.VariantType.Double),
            6108: (float(values['spoolProfileDensity0']), ua.VariantType.Double),
            6109: (float(values['spoolProfileDiameter0']), ua.VariantType.Double),
            6110: (str(values['spoolProfileMaterial0']), ua.VariantType.String),
            6111: (float(values['spoolTempOffset0']), ua.VariantType.Double),
            6112: (float(values['spoolUsed0']), ua.VariantType.Double),
            6113: (str(values['spoolProfileVendor0']), ua.VariantType.String),
            6114: (float(values['spoolWeight0']), ua.VariantType.Double),
            6115: (float(values['spoolUsed3']), ua.VariantType.Double),
            6116: (str(values['spoolProfileVendor3']), ua.VariantType.String),
            6117: (str(values['spoolName1']), ua.VariantType.String),
            6118: (float(values['spoolWeight3']), ua.VariantType.Double),
            6119: (float(values['spoolCost4']), ua.VariantType.Double),
            6120: (str(values['spoolName2']), ua.VariantType.String),
            6121: (float(values['spoolProfileDensity4']), ua.VariantType.Double),
            6122: (float(values['spoolProfileDiameter4']), ua.VariantType.Double),
            6123: (str(values['spoolName3']), ua.VariantType.String),
            6124: (str(values['spoolProfileMaterial4']), ua.VariantType.String),
            6125: (float(values['spoolTempOffset4']), ua.VariantType.Double),
            6126: (str(values['spoolName4']), ua.VariantType.String),
            6127: (float(values['spoolUsed4']) , ua.VariantType.Double),
            6128: (str(values['spoolProfileVendor4']), ua.VariantType.String),
            6129: (str(values['spoolName5']), ua.VariantType.String),
            6130: (float(values['spoolWeight4']) , ua.VariantType.Double),
            6131: (float(values['spoolCost5']) , ua.VariantType.Double),
            6132: (str(values['spoolName6']), ua.VariantType.String),
            6133: (float(values['spoolProfileDensity5']), ua.VariantType.Double),
            6134: (float(values['spoolProfileDiameter5']), ua.VariantType.Double),
            6135: (str(values['spoolProfileMaterial5']), ua.VariantType.String),
            6136: (float(values['spoolTempOffset5']), ua.VariantType.Double),
            6137: (float(values['spoolUsed5']), ua.VariantType.Double),
            6138: (str(values['spoolProfileVendor5']), ua.VariantType.String),
            6139: (float(values['spoolWeight5']), ua.VariantType.Double),
            6140: (float(values['spoolCost6']), ua.VariantType.Double),
            6141: (float(values['spoolProfileDensity6']), ua.VariantType.Double),
            6142: (float(values['spoolProfileDiameter6']), ua.VariantType.Double),
            6143: (str(values['spoolProfileMaterial6']), ua.VariantType.String),
            6144: (float(values['spoolTempOffset6']), ua.VariantType.Double),
            6145: (float(values['spoolCost7']) , ua.VariantType.Double),
            6146: (float(values['spoolProfileDensity7']), ua.VariantType.Double),
            6147: (float(values['spoolProfileDiameter7']), ua.VariantType.Double),
            6148: (str(values['spoolProfileMaterial7']), ua.VariantType.String),
            6149: (float(values['spoolTempOffset7']), ua.VariantType.Double),
            6150: (float(values['spoolCost8']), ua.VariantType.Double),
            6151: (float(values['spoolProfileDensity8']), ua.VariantType.Double),
            6152: (float(values['spoolProfileDiameter8']), ua.VariantType.Double),
            6153: (str(values['spoolProfileMaterial8']), ua.VariantType.String),
            6154: (float(values['spoolTempOffset8']), ua.VariantType.Double),
            6155: (float(values['spoolCost9']), ua.VariantType.Double),
            6156: (float(values['spoolProfileDensity9']), ua.VariantType.Double),
            6157: (float(values['spoolProfileDiameter9']), ua.VariantType.Double),
            6158: (str(values['spoolProfileMaterial9']), ua.VariantType.String),
            6159: (float(values['spoolTempOffset9']), ua.VariantType.Double),
            6160: (float(values['spoolUsed6']), ua.VariantType.Double),
            6161: (str(values['spoolProfileVendor6']), ua.VariantType.String),
            6162: (float(values['spoolWeight6']), ua.VariantType.Double),
            6163: (float(values['spoolUsed7']), ua.VariantType.Double),
            6164: (str(values['spoolProfileVendor7']), ua.VariantType.String),
            6165: (float(values['spoolWeight7']), ua.VariantType.Double),
            6166: (float(values['spoolUsed8']), ua.VariantType.Double),
            6167: (str(values['spoolProfileVendor8']), ua.VariantType.String),
            6168: (float(values['spoolWeight8']), ua.VariantType.Double),
            6169: (float(values['spoolUsed9']), ua.VariantType.Double),
            6170: (str(values['spoolProfileVendor9']), ua.VariantType.String),
            6171: (float(values['spoolWeight9']), ua.VariantType.Double)
        }
